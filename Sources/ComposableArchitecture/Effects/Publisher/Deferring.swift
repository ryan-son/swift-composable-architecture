...
extension Effect {
  ...
  @available(iOS, deprecated: 9999.0, message: "Use 'clock.sleep' in 'Effect.run', instead.")
  @available(macOS, deprecated: 9999.0, message: "Use 'clock.sleep' in 'Effect.run', instead.")
  @available(tvOS, deprecated: 9999.0, message: "Use 'clock.sleep' in 'Effect.run', instead.")
  @available(
    watchOS, deprecated: 9999.0, message: "Use 'clock.sleep' in 'Effect.run', instead."
  )
